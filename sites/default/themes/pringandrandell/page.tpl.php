...
<ul id="main-menu">
  ...
  <li id="menu-item-map" class="menu-item scroll"><a href="#map">map</a></li>
</ul><!-- #main-menu -->
...
<article id="carousel" class="section-wrapper clearfix" data-custom-background-img="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg6.jpg">
  <div class="content-wrapper clearfix">
        ...
        <div class="carousel-inner">
          ...
          <div class="item active">
            <div class="carousel-text-content">
              <img src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/transp-image1.png" class="icon" alt="Lorem Ipsum">
              ...
              <div class="content-to-populate-in-modal" id="modal-content-2">
                <h1>Lorem Ipsum</h1>
                <p><img data-img-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/transp-image1.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum">Etiam at ligula sit amet arcu laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. <a href="#">Suspendisse molestie lorem odio</a>, sit amet. </p>
          ...
          <div class="item">
            <div class="carousel-text-content">
              <img src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/transp-image6.png" class="icon" alt="Lorem Ipsum">
              ...
              <div class="content-to-populate-in-modal" id="modal-content-3">
                ...
                <p><img data-img-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/transp-image6.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum">Etiam at ligula sit amet arcu laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. <a href="#">Suspendisse molestie lorem odio</a>, sit amet. </p>
                <p>Laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio, sit amet.</p>
                <p>Suspendisse molestie lorem odio, sit amet. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio test.</p>
              </div><!-- #modal-content-3 -->
            </div>
          ...
          <div class="item">
            <div class="carousel-text-content">
              <img src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/transp-image7.png" class="icon" alt="Lorem Ipsum">
              ...
              <div class="content-to-populate-in-modal" id="modal-content-4">
                ...
                <p><img data-img-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/transp-image7.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum">Etiam at ligula sit amet arcu laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. <a href="#">Suspendisse molestie lorem odio</a>, sit amet. </p>
                <p>Laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio, sit amet.</p>
                <p>Suspendisse molestie lorem odio, sit amet. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio test.</p>
              </div><!-- #modal-content-4 -->
            </div>
          ...
          <div class="item">
            <div class="carousel-text-content">
              <img src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/transp-image4.png" class="icon" alt="Lorem Ipsum">
              ...
              <div class="content-to-populate-in-modal" id="modal-content-5">
                ...
                <p><img data-img-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/transp-image4.png" class="lazy rounded_border hover_effect pull-left" alt="Lorem Ipsum">Etiam at ligula sit amet arcu laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. <a href="#">Suspendisse molestie lorem odio</a>, sit amet. </p>
                <p>Laoreet consequat. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio, sit amet.</p>
                <p>Suspendisse molestie lorem odio, sit amet. Duis dictum lorem metus, vitae dapibus risus imperdiet nec. Suspendisse molestie lorem odio test.</p>
              </div><!-- #modal-content-5 -->
            </div>
...
<article id="grid" class="section-wrapper clearfix" data-custom-background-img="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg2.jpg">
  <div class="content-wrapper clearfix">
...
<article id="featured" class="section-wrapper clearfix" data-custom-background-img="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg3.jpg">
  <div class="content-wrapper clearfix">
        ...
        <section class="feature-columns row clearfix">
          ...
          <article class="feature-col col-md-4">
            <a href="" onclick="populate_and_open_modal(event, 'modal-content-6');" class="thumbnail linked">
              <div class="image-container">
                <img data-img-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/project-3.jpg" class="lazy item-thumbnail" alt="Lorem Ipsum">
              </div>
              <div class="caption">
            ...
            <div class="content-to-populate-in-modal" id="modal-content-6">
              ...
              <div id="unique-id-for-image-slider" class="owl-carousel popup-image-gallery">
                ...
                <div>
                  ...
                  <img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg1.jpg">
                </div>
                <!-- slide -->
                <div>
                  <h6 class="caption">Caption for Image 2</h6>
                  <img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg2.jpg">
                </div>
                <!-- slide -->
                <div>
                  <h6 class="caption">Caption for Image 3</h6>
                  <img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg3.jpg">
                </div>
              </div>
            </div><!-- #modal-content-6 -->
          </article>
          ...
          <article class="feature-col col-md-4">
            <a href="" onclick="populate_and_open_modal(event, 'modal-content-7');" class="thumbnail linked">
              <div class="image-container">
                <img data-img-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/project-2.jpg" class="lazy item-thumbnail" alt="Lorem Ipsum">
              </div>
              <div class="caption">
                <h5>Text popup</h5>
            ...
            <div class="content-to-populate-in-modal" id="modal-content-7">
              <img data-img-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/top-image2.jpg" class="lazy full-width" alt="Lorem Ipsum">
              <h1>Sed scelerisque</h1>
          ...
          <article class="feature-col col-md-4">
            <a href="" onclick="populate_and_open_modal(event, 'modal-content-8', '', 'full-size');" class="thumbnail linked">
              <div class="image-container">
                <img data-img-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/project-4.jpg" class="lazy item-thumbnail" alt="Lorem Ipsum">
              </div>
              <div class="caption">
            ...
            <div class="content-to-populate-in-modal" id="modal-content-8">
              ...
              <div id="unique-id-for-alt-image-slider" class="owl-carousel popup-alt-image-gallery">
                <div class="item"><a href="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg1.jpg" data-lightbox="popup-alt-gallery"><img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/gallery-thumb-1.jpg"></a></div>
                <div class="item"><a href="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg2.jpg" data-lightbox="popup-alt-gallery"><img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/gallery-thumb-2.jpg"></a></div>
                <div class="item"><a href="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg3.jpg" data-lightbox="popup-alt-gallery"><img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/gallery-thumb-3.jpg"></a></div>
                <div class="item"><a href="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg4.jpg" data-lightbox="popup-alt-gallery"><img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/gallery-thumb-4.jpg"></a></div>
                <div class="item"><a href="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/Chromatic10Hand.jpg" data-lightbox="popup-alt-gallery"><img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/gallery-thumb-5.jpg"></a></div>
                <div class="item"><a href="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg6.jpg" data-lightbox="popup-alt-gallery"><img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/gallery-thumb-6.jpg"></a></div>
                <div class="item"><a href="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg2.jpg" data-lightbox="popup-alt-gallery"><img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/gallery-thumb-2.jpg"></a></div>
                <div class="item"><a href="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg3.jpg" data-lightbox="popup-alt-gallery"><img class="lazyOwl" data-src="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/gallery-thumb-3.jpg"></a></div>
              </div>
            </div><!-- #modal-content-8 -->
...
<article id="contact" class="section-wrapper clearfix" data-custom-background-img="<?php print base_path() . path_to_theme(); ?>/assets/images/other_images/bg4.jpg">
  <div class="content-wrapper clearfix">
