  ...
  <div class="content-wrapper clearfix wow fadeInDown" data-wow-delay="0.3s">
    <div class="col-sm-10 col-md-9 pull-right">
        ...
        <section class="feature-text">
          ...
          <p><a href="#story" class="link-scroll btn btn-outline-inverse btn-sm">find out more</a></p>
        </section>
...
<?php if (isset($page['rsvp'])): ?>
<article id="rsvp" class="section-wrapper clearfix" data-custom-background-img="<?php print base_path() . path_to_theme(); ?>/assets/images/Chromatic10Hand.jpg">
  <div class="content-wrapper clearfix">
    <div class="col-sm-10 col-md-9 pull-right">

      <?php print render($page['rsvp']); ?>  
